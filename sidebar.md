...
Situs ini digunakan untuk mendeteksi masker wajah dari gambar yang diupload oleh user dan memberikan hasilnya berupa gambar yang terproses.

Gambar yang terproses diberi label beserta confidence score.
